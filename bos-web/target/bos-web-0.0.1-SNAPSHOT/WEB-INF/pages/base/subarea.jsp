...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			...
			var formJsons = $("#searchForm").serializeJson();
			$("#grid").datagrid('load',formJsons);

		});
		
	});
	//扩展jQuery的方法，将form表单中的值，封装成一个json数组（json数组用于datagrid的load方法中）
	$.fn.serializeJson=function(){  
        var serializeObj={};  
        var array=this.serializeArray();
        $(array).each(function(){  //查看jq文档可了解，遍历的每一个临时对象都是被遍历对象的子对象，在这是json对象
            if(serializeObj[this.name]){  //this是一个json对象，访问他的属性可以用.或[]等访问
                ...
                serializeObj[this.name]=this.value;   //对json对象进行赋值
            }  
        });  
        return serializeObj;  
    }; 
