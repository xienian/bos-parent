 ...
 * Generated at: 2021-08-21 01:17:53 UTC
...
public final class subarea_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t//页面加载完成后，调用ocupload对象方法\r\n");
      ...
      out.write("\t        resizable:false\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t//有过滤条件查询分区数据\r\n");
      out.write("\t\t$(\"#btn\").click(function(){\r\n");
      out.write("\t\t\t$(\"#searchWindow\").window(\"close\");\r\n");
      out.write("\t\t\tvar formJsons = $(\"#searchForm\").serializeJson();\r\n");
      out.write("\t\t\t$(\"#grid\").datagrid('load',formJsons);\r\n");
      out.write("\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t});\r\n");
      out.write("\t//扩展jQuery的方法，将form表单中的值，封装成一个json数组（json数组用于datagrid的load方法中）\r\n");
      out.write("\t$.fn.serializeJson=function(){  \r\n");
      out.write("        var serializeObj={};  \r\n");
      out.write("        var array=this.serializeArray();\r\n");
      out.write("        $(array).each(function(){  //查看jq文档可了解，遍历的每一个临时对象都是被遍历对象的子对象，在这是json对象\r\n");
      out.write("            if(serializeObj[this.name]){  //this是一个json对象，访问他的属性可以用.或[]等访问\r\n");
      ...
      out.write("                }  \r\n");
      out.write("            }else{  \r\n");
      out.write("                serializeObj[this.name]=this.value;   //对json对象进行赋值\r\n");
      out.write("            }  \r\n");
      out.write("        });  \r\n");
