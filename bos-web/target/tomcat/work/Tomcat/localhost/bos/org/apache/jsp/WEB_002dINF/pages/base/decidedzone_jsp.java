 ...
 * Generated at: 2021-08-21 01:17:52 UTC
...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t/*\r\n");
      out.write("\t\t1.获取当前被选中了的定区数据（只能选中一个）；\r\n");
      out.write("\t\t2.查询未关联定区的所有客户数据+已经关联本定区的客户数据；\r\n");
      out.write("\t\t3.调整页面，让其可以关联和取消关联；\r\n");
      out.write("\t\t4.点击“保存关联”按钮后，将目前所有在“没关联定区”的客户数据保存，将“已关联定区”的客户保存；\r\n");
      out.write("\t\t5.显示定区数据；\r\n");
      out.write("\t\t*/\r\n");
      out.write("\t\tvar decidedzoneSelect = $('#grid').datagrid('getSelections');\r\n");
      out.write("\t\tif(decidedzoneSelect.length != 1){\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选择一个定区操作！\",\"warning\");\r\n");
      out.write("\t\t}else if (decidedzoneSelect.length == 1) {\r\n");
      out.write("\t\t\t$('#customerWindow').window('open');\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#noassociationSelect\").empty();\r\n");
      out.write("\t\t\t$(\"#associationSelect\").empty();\r\n");
      out.write("\t\t\t//获取未关联定区的客户\r\n");
      out.write("\t\t\tvar noassociationUrl = \"decidedzoneAction_findListNotAssociation.action\";\r\n");
      out.write("\t\t\t$.post(noassociationUrl,function(data){\r\n");
      out.write("\t\t\t\tvar $noassociation = $(\"#noassociationSelect\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tfor(i=0; i<data.length; i++){\r\n");
      out.write("\t\t\t\t\t//获取字段数据，组合成下拉选项的属性和数据\r\n");
      ...
      out.write("\t\t\t\t\t$noassociation.append(\"<option value='\"+id+\"'>\"+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t//获取关联了定区的客户\r\n");
      out.write("\t\t\tvar hasassociationUrl = \"decidedzoneAction_findListHasAssociation.action\";\r\n");
      out.write("\t\t\tvar decidedzoneId = decidedzoneSelect[0].id;\r\n");
      out.write("\t\t\t$.post(hasassociationUrl,{\"id\":decidedzoneId},function(data){\r\n");
      out.write("\t\t\t\tvar $hasassociation = $(\"#associationSelect\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tfor(i=0; i<data.length; i++){\r\n");
      out.write("\t\t\t\t\t//获取字段数据，组合成下拉选项的属性和数据\r\n");
      out.write("\t\t\t\t\tvar id = data[i].id;\r\n");
      ...
      out.write("\t\t\t\t\tvar telephone = data[i].telephone;\r\n");
      out.write("\t\t\t\t\tname = name + \"(\" +telephone+\")\";\r\n");
      out.write("\t\t\t\t\t$hasassociation.append(\"<option value='\"+id+\"'>\"+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t    });\r\n");
      out.write("\t\t/*\r\n");
      out.write("\t\t定区查询按钮中，“查询”事件\r\n");
      out.write("\t\t1.上传查询参数，定区id和取派员所属公司；\r\n");
      out.write("\t\t*/\r\n");
      out.write("\t\t$(\"#btn\").click(function(){\r\n");
      out.write("\t\t\tvar v = $(\"#searchForm\").form('validate');\r\n");
      out.write("\t\t\tif(v){\r\n");
      out.write("\t\t\t\tvar id = $(\"#searchid\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar staff = $(\"#searchstation\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$(\"#grid\").datagrid(\"load\",{\"page\":\"1\",\"rows\":\"10\",\"id\":id.val(),\"staff.station\":staff.val()});\r\n");
      ...
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"subareaAction_findListByDecidedzoneId.action?decidedzone.id=\"+data.id,\r\n");
      out.write("\t\t\tcolumns : [ [{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<!-- 添加 修改分区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"111\" id=\"addDecidedzoneWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write("\t\t\t<form id=\"addDecidedzoneForm\" action=\"decidedzoneAction_add.action\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" id=\"searchId\" name=\"id\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>定区名称</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\"  id=\"searchStation\" name=\"name\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"searchForm\" action=\"decidedzoneAction_search.action\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" id=\"searchstation\" name=\"staff.station\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t//先给form表单内代表定区id的表单赋值\r\n");
      out.write("\t\t\t\t\t\t\t\tvar rows = $(\"#grid\").datagrid('getSelections');\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#customerDecidedZoneId\").val(rows[0].id);\r\n");
      out.write("\t\t\t\t\t\t\t\t//将所有：已关联定区的客户下拉表单的选项设为以选中，这样提交表单时就会上传name\r\n");
