 ...
 * Generated at: 2021-08-21 01:18:01 UTC
...
public final class noticebill_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t$(function () {\r\n");
      out.write("\t\t\t\t\t$(\"#save\").click(function () {\r\n");
      out.write("\t\t\t\t\t\tvar validate = $(\"#noticebillForm\").form(\"validate\");\r\n");
      ...
      out.write("\t\t\t\t\t<!-- 给“来电号码”文本框绑定焦点事件：鼠标离开后触发 -->\r\n");
      out.write("\t\t\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\t\t\t\t$(function() {\r\n");
      out.write("\t\t\t\t\t\t\t$(\"input[name='telephone']\").blur(function () {\r\n");
      out.write("\t\t\t\t\t\t\t\t/*\r\n");
      out.write("\t\t\t\t\t\t\t\t1.获取手机号；\r\n");
      out.write("\t\t\t\t\t\t\t\t2.异步根据手机号查询客户信息；\r\n");
      out.write("\t\t\t\t\t\t\t\t3.如果有数据，就将信息写入其他表单中；没有，就写入空；\r\n");
      out.write("\t\t\t\t\t\t\t\t*/\r\n");
